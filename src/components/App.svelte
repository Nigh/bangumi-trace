<script lang="ts">
  ...
  let editingVolumeId = "", editingVolumeEpisodes = 1, editingNote = false, noteDraft = ""
  ...
  function route(hash = location.hash) {
    ...
    view = next; selectedId = id; activeSubtitle = -1; editingVolumeId = ""; editingNote = false
